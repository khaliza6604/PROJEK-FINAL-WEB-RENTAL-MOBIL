...
class UserController extends Controller
{
    ...
    {
        $nama_mobil = $request->input('nama_mobil'); // Ambil nilai yang diinputkan pengguna (berdasarakan nama mobil)
        // $jumlah_kursi = $request->input('nama_mobil'); // Ambil nilai yang diinputkan pengguna (berdasarkan jumlah kursi)
    
        $cars = Car::where('nama_mobil', 'like', '%' . $nama_mobil . '%')->get();
        // $cars = Car::where('nama_mobil', 'like', '%' . $jumlah_kursi . '%')->get();
