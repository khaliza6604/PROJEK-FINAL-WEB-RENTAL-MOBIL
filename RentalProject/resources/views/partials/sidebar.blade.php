<style>
    #accordionSidebar li.nav-item a.nav-link:hover {
        background-color: #885e43;
        color: #fff;
    }

    #accordionSidebar li.nav-item a.nav-link.collapsed:hover {
        background-color: #885e43;
        color: #fff;
    }

    #accordionSidebar li.nav-item .collapse-inner a.collapse-item:hover {
        background-color: #885e43;
        color: #fff;
    }
...
<ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #c39a74;">
