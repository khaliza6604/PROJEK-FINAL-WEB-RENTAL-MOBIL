...
<head>
    ...
    <title>Kuruma Rent - くるま レンタル</title>
    <!-- Favicon-->
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light pt-3 pb-3">
        <div class="container px-4 px-lg-5">
            <a class="navbar-brand" href="{{ route('homepage') }}" style="color: white">Kuruma Rent - くるま レンタル</a>
    ...
    @yield('content')
    <!-- Footer-->
    <footer class="py-3 sticky-bottom mt-5" style="background-color: #66574f">
        <div class="container">
