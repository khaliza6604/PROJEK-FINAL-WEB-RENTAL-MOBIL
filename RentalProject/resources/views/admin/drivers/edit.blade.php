            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('drivers.update', $driver->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn" style="background-color: #c39a74; color: black">Simpan</button>
                            <a class="btn mt-auto text-white" href="/admin/drivers" style="background-color: #885e43" >Back</a>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card-body">
                <form action="{{ route('drivers.updateImage', $driver->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn" style="background-color: #c39a74; color: white">Simpan</button>
                    </div>
                </form>
            </div>
        </div>
